...
echo "find ${WORKING_DIR}/../sample/microsoft/src -regextype posix-extended -iregex '.*[.](h|cpp)' ! -iregex '.*/model/.*' | xargs $WORKING_DIR/cpplint.py --filter=+legal,+build,+readability,+runtime,+whitespace,-whitespace/blank_line,-runtime/printf || true"
