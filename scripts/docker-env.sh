...
if [ -n "${DOCKER_NAME}" ]; then
  ...
  #export DOCKER_NAME=${DOCKER_NAME:-"nabla-cpp-test"} # build image
  export DOCKER_NAME=${DOCKER_NAME:-"nabla-cpp"} # runtime image
...
export DOCKER_NAME_BUILD=${DOCKER_NAME_BUILD:-"nabla-cpp-test"}
export DOCKER_RUNTIME_NAME=${DOCKER_NAME:-"nabla-cpp"}
export DOCKER_TAG=${DOCKER_TAG:-"latest"}
