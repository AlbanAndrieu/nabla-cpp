...
def run(args):
    ...
    parser.add_option('--altfile', default='-',
    ...
    parser.add_option('--graph-opt', default=[], action='append',
                      help='Dot graph option, as a key=value pair.')
    parser.add_option('--node-opt',  default=[], action='append',
                      help='Dot node option, as a key=value pair.')
    parser.add_option('--edge-opt',  default=[], action='append',
